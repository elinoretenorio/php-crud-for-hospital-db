...
use Hospital\Diagnosis\{ DiagnosisDto, DiagnosisModel, DiagnosisController };
...
class DiagnosisControllerTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->service = $this->createMock("Hospital\Diagnosis\IDiagnosisService");
    ...
    public function testGet_ReturnsResponse(): void
    {
        ...
        $args = ["diagnosis_id" => 7401];

        $this->service->expects($this->once())
            ->method("get")
            ->with($args["diagnosis_id"])
            ->willReturn($this->model);

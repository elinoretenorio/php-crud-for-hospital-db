...
use Hospital\Medication\{ MedicationDto, MedicationModel, MedicationController };
...
class MedicationControllerTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->service = $this->createMock("Hospital\Medication\IMedicationService");
    ...
    public function testGet_ReturnsResponse(): void
    {
        ...
        $args = ["medication_id" => 8471];

        $this->service->expects($this->once())
            ->method("get")
            ->with($args["medication_id"])
            ->willReturn($this->model);
